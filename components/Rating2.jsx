...
export default function Rating2({ id ,name , setRefresh }) {
  ...
  <div className="bg-white rounded-2xl border border-gray-800 p-8 w-full max-w-sm text-center">
    ...
    {!submitted ? (
      <>
        ...
        <textarea
          ...
          rows={3}
          className="w-full rounded-xl border border-gray-800 p-3 text-sm text-gray-700 resize-none focus:outline-none focus:ring-2 focus:ring-gray-400 mb-4"
        />

        <button
          onClick={handleSubmit}
          disabled={rating === 0}
          className="w-full py-2 rounded-xl font-semibold text-white bg-gray-800 hover:bg-gray-700 transition-all duration-200"
        >
          Enviar calificación
        </button>
      </>
